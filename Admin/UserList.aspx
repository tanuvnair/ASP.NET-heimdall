...
<asp:Content ContentPlaceHolderID="AdminBodyContent" runat="server">
    <div class="m-5">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Laptop %>" SelectCommand="SELECT [UserID], [Username], [Email], [IsEmailVerified], [PhoneNumber], [Role], [CreatedAt] FROM [Users]"></asp:SqlDataSource>
